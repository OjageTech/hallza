import { Text, Flex, VStack, Grid, GridItem } from '@chakra-ui/react';
	...
	return (
		<Box margin="0 auto" w="70vw">
			...
			<Grid
				...
				gap={{ sm: '.6rem', md:'.8rem', lg: '1.5rem', xl:'2.3rem' }}>
				{FeatureData.map(({ title, subtitle, content, newBadge, color }) => {
					return (
						<Feature
							title={title}
							subtitle={subtitle}
