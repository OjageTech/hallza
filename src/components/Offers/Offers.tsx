  ...
  return (
    <Box ml="2.8rem" mb=".9rem">
      ...
      <Flex mt=".8rem" gap="1rem">
        <Flex justifyContent="space-between" h="22vh" borderRadius={7} boxShadow="rgba(0, 0, 0, 0.1) 0px 4px 12px;">
          <Box pl="1rem" pt="1rem">
        ...
        <Box w="54%" color="white" backgroundSize="cover" backgroundImage={ConfHall2} h="22vh" borderRadius={7} boxShadow="rgba(0, 0, 0, 0.1) 0px 4px 12px;">
          <Box w="50%" m="1rem">
