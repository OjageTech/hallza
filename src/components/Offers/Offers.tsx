...
function Offers() {
  return (
    <Box ml="2.1rem" mr="2.1rem" mb=".9rem" mt={{ base: '0', md: '2rem' }}>
      ...
      <Flex mt=".8rem" gap="1rem" flexDir={{ base: 'column', md: 'row' }}>
        ...
        <Box w={{ base: '100%', md: '52%' }} color="white" backgroundSize="contain" position="relative" h="30vh" borderRadius={7} boxShadow="rgba(0, 0, 0, 0.1) 0px 4px 12px;">
          <Box borderRadius={7} zIndex="-1" pos="absolute" top="0" left="0" h="100%" w="100%" backgroundImage="url(https://img.freepik.com/free-vector/fashion-model-with-summer-outfit_79603-528.jpg?size=626&ext=jpg&ga=GA1.1.513754652.1688231868&semt=ais)" transform="rotateY(180deg)" />
          <Box
