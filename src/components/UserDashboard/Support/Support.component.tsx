...
const SearchSection: React.FC = () => (
  <Container>
    <VStack justifyContent="left" alignItems="left" gap="1rem">
      <Text as="h1" textTransform="capitalize" fontWeight={600} fontSize="24px">
...
const Support: React.FC = () => {
  ...
  return (
    <Container textAlign="left" p={0} mt="0" ml={expanded ? '16.7rem' : '9rem'}>
      <Flex>
        <Box variant="sideNav" display={expanded ? 'none' : 'block'}>
          <SearchAndFAQ />
        </Box>
        <Container mt="7rem" pt="4rem">
          lorem ipsum dolor kdjgoieglgsndspoid pgew pow qopg gpwbegwpj guiwgwepi
